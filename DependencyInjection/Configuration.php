            ...
            ->children()
                ...
                ->end()
								->arrayNode('include')
									->prototype('scalar')
									->validate()
										->ifNotInArray(array('font-awesome','xeditable','jqueryui', 'jqueryuitouch', 'jsplumb', 'jcrop','datepicker','image-gallery','jqueryform','jwplayer','flexslider','easy-pie-chart','jquery-flot','fuelux-wizard', 'jquery-mask', 'jquery-validate', 'jquery-collagePlus', 'jquery-md5', 'jquery-chosen', 'xeditable-select2'))
